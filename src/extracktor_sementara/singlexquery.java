    ...
    private static String AudioSignatureType() throws BaseXException{
        ...
        String query =
                "declare default element namespace \"urn:mpeg:mpeg7:schema:2001\";" +
                        ...
                        "for $x in doc(\"D:\\hari\\FULL\\Isyana Sarasvati - Tetap Dalam Jiwa.xml\")/Mpeg7/Description/MultimediaContent/Audio/AudioDescriptionScheme return if($x/@xsi:type=\"AudioSignatureType\")then data($x/Flatness/SeriesOfVector/Mean) else \"\"";
