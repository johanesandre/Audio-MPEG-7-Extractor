...
public class DescriptorTes {
    ...
    private static String AudioSpectrumSpreadType() throws BaseXException{
     ...
     public static String SoundModel() throws BaseXException{
        String query =
                "declare default element namespace \"urn:mpeg:mpeg7:schema:2001\";" +
                        "declare namespace mpeg7 = \"urn:mpeg:mpeg7:schema:2001\";" +
                        "declare namespace xsi = \"http://www.w3.org/2001/XMLSchema-instance\";" +
                        "for $x in doc(\"D:\\Lagu Extract\\Coba\\Rap\\1 Detik.xml\")/Mpeg7/Description/MultimediaContent/Audio/AudiDescriptor\n return if($x/@xsi:type=\"SoundModelType\")then data($x/Initial/Transitions) else \"\"";
  String hasil = new XQuery(query).execute(context);
